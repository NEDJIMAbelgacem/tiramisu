...
int gpu_tiramisu_make_fused_dibaryon_blocks_correlator(struct halide_buffer_t *_C_r_buffer, struct halide_buffer_t *_C_i_buffer, struct halide_buffer_t *_B1_prop_r_buffer, struct halide_buffer_t *_B1_prop_i_buffer, struct halide_buffer_t *_B2_prop_r_buffer, struct halide_buffer_t *_B2_prop_i_buffer, struct halide_buffer_t *_src_psi_B1_r_buffer, struct halide_buffer_t *_src_psi_B1_i_buffer, struct halide_buffer_t *_src_psi_B2_r_buffer, struct halide_buffer_t *_src_psi_B2_i_buffer, struct halide_buffer_t *_snk_psi_B1_r_buffer, struct halide_buffer_t *_snk_psi_B1_i_buffer, struct halide_buffer_t *_snk_psi_B2_r_buffer, struct halide_buffer_t *_snk_psi_B2_i_buffer, struct halide_buffer_t *_hex_src_psi_r_buffer, struct halide_buffer_t *_hex_src_psi_i_buffer, struct halide_buffer_t *_hex_snk_psi_r_buffer, struct halide_buffer_t *_hex_snk_psi_i_buffer, struct halide_buffer_t *_snk_psi_r_buffer, struct halide_buffer_t *_snk_psi_i_buffer, struct halide_buffer_t *_buf_src_spins_buffer, struct halide_buffer_t *_src_spin_block_weights_buffer, struct halide_buffer_t *_sigs_buffer, struct halide_buffer_t *_src_color_weights_buffer, struct halide_buffer_t *_src_spin_weights_buffer, struct halide_buffer_t *_src_weights_buffer, struct halide_buffer_t *_buf_snk_b_buffer, struct halide_buffer_t *_snk_color_weights_buffer, struct halide_buffer_t *_snk_spin_weights_buffer, struct halide_buffer_t *_snk_weights_buffer, struct halide_buffer_t *_hex_snk_color_weights_buffer, struct halide_buffer_t *_hex_snk_spin_weights_buffer, struct halide_buffer_t *_hex_snk_weights_buffer) HALIDE_FUNCTION_ATTRS;
int gpu_tiramisu_make_fused_dibaryon_blocks_correlator_old_buffer_t(struct buffer_t *_C_r, struct buffer_t *_C_i, struct buffer_t *_B1_prop_r, struct buffer_t *_B1_prop_i, struct buffer_t *_B2_prop_r, struct buffer_t *_B2_prop_i, struct buffer_t *_src_psi_B1_r, struct buffer_t *_src_psi_B1_i, struct buffer_t *_src_psi_B2_r, struct buffer_t *_src_psi_B2_i, struct buffer_t *_snk_psi_B1_r, struct buffer_t *_snk_psi_B1_i, struct buffer_t *_snk_psi_B2_r, struct buffer_t *_snk_psi_B2_i, struct buffer_t *_hex_src_psi_r, struct buffer_t *_hex_src_psi_i, struct buffer_t *_hex_snk_psi_r, struct buffer_t *_hex_snk_psi_i, struct buffer_t *_snk_psi_r, struct buffer_t *_snk_psi_i, struct buffer_t *_buf_src_spins, struct buffer_t *_src_spin_block_weights, struct buffer_t *_sigs, struct buffer_t *_src_color_weights, struct buffer_t *_src_spin_weights, struct buffer_t *_src_weights, struct buffer_t *_buf_snk_b, struct buffer_t *_snk_color_weights, struct buffer_t *_snk_spin_weights, struct buffer_t *_snk_weights, struct buffer_t *_hex_snk_color_weights, struct buffer_t *_hex_snk_spin_weights, struct buffer_t *_hex_snk_weights) HALIDE_FUNCTION_ATTRS;
