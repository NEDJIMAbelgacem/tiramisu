#ifndef HALIDE__generated_gpu_tiramisu_make_fused_baryon_blocks_correlator_o_h
#define HALIDE__generated_gpu_tiramisu_make_fused_baryon_blocks_correlator_o_h
#include <stdint.h>
...
int tiramisu_make_fused_baryon_blocks_correlator(struct halide_buffer_t *_buf_C_r_cpu_buffer, struct halide_buffer_t *_buf_C_i_cpu_buffer, struct halide_buffer_t *_B1_prop_r_cpu_buffer, struct halide_buffer_t *_B1_prop_i_cpu_buffer, struct halide_buffer_t *_src_psi_B1_r_cpu_buffer, struct halide_buffer_t *_src_psi_B1_i_cpu_buffer, struct halide_buffer_t *_snk_psi_r_cpu_buffer, struct halide_buffer_t *_snk_psi_i_cpu_buffer, struct halide_buffer_t *_src_color_weights_cpu_buffer, struct halide_buffer_t *_src_spin_weights_cpu_buffer, struct halide_buffer_t *_src_weights_cpu_buffer, struct halide_buffer_t *_src_spins_cpu_buffer, struct halide_buffer_t *_snk_color_weights_cpu_buffer, struct halide_buffer_t *_snk_spin_weights_cpu_buffer, struct halide_buffer_t *_snk_weights_cpu_buffer, struct halide_buffer_t *_sigs_cpu_buffer) HALIDE_FUNCTION_ATTRS;
int tiramisu_make_fused_baryon_blocks_correlator_old_buffer_t(struct buffer_t *_buf_C_r_cpu, struct buffer_t *_buf_C_i_cpu, struct buffer_t *_B1_prop_r_cpu, struct buffer_t *_B1_prop_i_cpu, struct buffer_t *_src_psi_B1_r_cpu, struct buffer_t *_src_psi_B1_i_cpu, struct buffer_t *_snk_psi_r_cpu, struct buffer_t *_snk_psi_i_cpu, struct buffer_t *_src_color_weights_cpu, struct buffer_t *_src_spin_weights_cpu, struct buffer_t *_src_weights_cpu, struct buffer_t *_src_spins_cpu, struct buffer_t *_snk_color_weights_cpu, struct buffer_t *_snk_spin_weights_cpu, struct buffer_t *_snk_weights_cpu, struct buffer_t *_sigs_cpu) HALIDE_FUNCTION_ATTRS;
