#ifndef HALIDE__generated_gpu_tiramisu_make_fused_dibaryon_blocks_correlator_o_h
#define HALIDE__generated_gpu_tiramisu_make_fused_dibaryon_blocks_correlator_o_h
#include <stdint.h>
...
int gpu_tiramisu_make_fused_dibaryon_blocks_correlator(struct halide_buffer_t *_buf_C_r_cpu_buffer, struct halide_buffer_t *_buf_C_i_cpu_buffer, struct halide_buffer_t *_buf_B1_prop_r_cpu_buffer, struct halide_buffer_t *_buf_B1_prop_i_cpu_buffer, struct halide_buffer_t *_buf_B2_prop_r_cpu_buffer, struct halide_buffer_t *_buf_B2_prop_i_cpu_buffer, struct halide_buffer_t *_buf_src_psi_B1_r_cpu_buffer, struct halide_buffer_t *_buf_src_psi_B1_i_cpu_buffer, struct halide_buffer_t *_buf_src_psi_B2_r_cpu_buffer, struct halide_buffer_t *_buf_src_psi_B2_i_cpu_buffer, struct halide_buffer_t *_buf_snk_psi_B1_r_cpu_buffer, struct halide_buffer_t *_buf_snk_psi_B1_i_cpu_buffer, struct halide_buffer_t *_buf_snk_psi_B2_r_cpu_buffer, struct halide_buffer_t *_buf_snk_psi_B2_i_cpu_buffer, struct halide_buffer_t *_buf_hex_src_psi_r_cpu_buffer, struct halide_buffer_t *_buf_hex_src_psi_i_cpu_buffer, struct halide_buffer_t *_buf_hex_snk_psi_r_cpu_buffer, struct halide_buffer_t *_buf_hex_snk_psi_i_cpu_buffer, struct halide_buffer_t *_buf_snk_psi_r_cpu_buffer, struct halide_buffer_t *_buf_snk_psi_i_cpu_buffer, struct halide_buffer_t *_buf_src_spins_cpu_buffer, struct halide_buffer_t *_buf_src_spin_block_weights_cpu_buffer, struct halide_buffer_t *_buf_sigs_cpu_buffer, struct halide_buffer_t *_buf_src_color_weights_cpu_buffer, struct halide_buffer_t *_buf_src_spin_weights_cpu_buffer, struct halide_buffer_t *_buf_src_weights_cpu_buffer, struct halide_buffer_t *_buf_snk_b_cpu_buffer, struct halide_buffer_t *_buf_snk_color_weights_cpu_buffer, struct halide_buffer_t *_buf_snk_spin_weights_cpu_buffer, struct halide_buffer_t *_buf_snk_weights_cpu_buffer, struct halide_buffer_t *_buf_hex_snk_color_weights_cpu_buffer, struct halide_buffer_t *_buf_hex_snk_spin_weights_cpu_buffer, struct halide_buffer_t *_buf_hex_snk_weights_cpu_buffer) HALIDE_FUNCTION_ATTRS;
int gpu_tiramisu_make_fused_dibaryon_blocks_correlator_old_buffer_t(struct buffer_t *_buf_C_r_cpu, struct buffer_t *_buf_C_i_cpu, struct buffer_t *_buf_B1_prop_r_cpu, struct buffer_t *_buf_B1_prop_i_cpu, struct buffer_t *_buf_B2_prop_r_cpu, struct buffer_t *_buf_B2_prop_i_cpu, struct buffer_t *_buf_src_psi_B1_r_cpu, struct buffer_t *_buf_src_psi_B1_i_cpu, struct buffer_t *_buf_src_psi_B2_r_cpu, struct buffer_t *_buf_src_psi_B2_i_cpu, struct buffer_t *_buf_snk_psi_B1_r_cpu, struct buffer_t *_buf_snk_psi_B1_i_cpu, struct buffer_t *_buf_snk_psi_B2_r_cpu, struct buffer_t *_buf_snk_psi_B2_i_cpu, struct buffer_t *_buf_hex_src_psi_r_cpu, struct buffer_t *_buf_hex_src_psi_i_cpu, struct buffer_t *_buf_hex_snk_psi_r_cpu, struct buffer_t *_buf_hex_snk_psi_i_cpu, struct buffer_t *_buf_snk_psi_r_cpu, struct buffer_t *_buf_snk_psi_i_cpu, struct buffer_t *_buf_src_spins_cpu, struct buffer_t *_buf_src_spin_block_weights_cpu, struct buffer_t *_buf_sigs_cpu, struct buffer_t *_buf_src_color_weights_cpu, struct buffer_t *_buf_src_spin_weights_cpu, struct buffer_t *_buf_src_weights_cpu, struct buffer_t *_buf_snk_b_cpu, struct buffer_t *_buf_snk_color_weights_cpu, struct buffer_t *_buf_snk_spin_weights_cpu, struct buffer_t *_buf_snk_weights_cpu, struct buffer_t *_buf_hex_snk_color_weights_cpu, struct buffer_t *_buf_hex_snk_spin_weights_cpu, struct buffer_t *_buf_hex_snk_weights_cpu) HALIDE_FUNCTION_ATTRS;
