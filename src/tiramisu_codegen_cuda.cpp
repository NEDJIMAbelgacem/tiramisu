        ...
        switch (tiramisu_expr.get_expr_type()) {
            ...
            case e_op: {
                ...
                switch (tiramisu_expr.get_op_type()) {
                    ...
                    case o_memcpy:
                        print_indent(parse_tiramisu_level - 1);
                        std::cerr << "tiramisu_expr.get_op_type(): o_memcpy : " << tiramisu_expr.get_operand(0).to_str() << " | " << tiramisu_expr.get_operand(1).to_str() << "\n";
...
//        this->print(ss, base + "\t");
    ...
    bool cuda_ast::compiler::compile_cpu_obj(const std::string &filename, const std::string &obj_name) const {
        ...
        command << " -O0";
        command << " -g -G";
        command << " -gencode arch=compute_10,code=sm_10";
