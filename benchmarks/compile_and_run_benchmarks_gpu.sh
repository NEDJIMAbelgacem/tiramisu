...
${CXX} ${CXXFLAGS} ${INCLUDES} -I${TIRAMISU_ROOT}/benchmarks/tensors/baryon/gpu_parts/ ${KERNEL}_wrapper.cpp generated_${KERNEL}.o ${LIBRARIES_DIR} ${LIBRARIES} -o ${KERNEL}_wrapper.o 
