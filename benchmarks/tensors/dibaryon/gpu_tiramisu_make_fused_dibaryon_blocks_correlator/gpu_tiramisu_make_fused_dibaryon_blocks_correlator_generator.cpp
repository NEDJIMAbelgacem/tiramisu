...
void generate_function(std::string name)
{
   ...
   buffer buf_hex_snk_weights_cpu("buf_hex_snk_weights_cpu", {B2Nrows, Nw2Hex}, p_float64, a_temporary);
    ...
    complex_computation access_flip_B1_Bfirst_r2_init( "access_flip_B1_Bfirst_r2_init" , {t, x_out, x_in, x2, rp, m, r, s, nperm, wnum}, 
        flip_B1_Bfirst_r2_init(t, x_out, x_in, x2, 
                snk_color_weights_0_0, snk_color_weights_0_0, snk_color_weights_2_0, snk_color_weights_2_0, snk_color_weights_1_0, snk_color_weights_1_0, m
                ) );


    complex_computation flip_BB_BB_new_term_2_r2_b1("flip_BB_BB_new_term_2_r2_b1", {t, x_out, x_in, x2, rp, m, r, s, nperm, wnum}, access_flip_B1_Bfirst_r2_init );
