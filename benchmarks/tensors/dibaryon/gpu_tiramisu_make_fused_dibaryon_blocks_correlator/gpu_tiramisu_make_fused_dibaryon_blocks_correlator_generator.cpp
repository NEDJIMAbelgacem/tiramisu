...
// computation B1_Blocal_r2_r_diquark("B1_Blocal_r2_r_diquark", {t, x_out, x_in, x2, iCprime, iSprime, kCprime, kSprime, y, wnumBlock}, B1_r2_diquark.get_real());
    ...
    buffer buf_B1_Blocal_props_r2_r("buf_B1_Blocal_props_r2_r",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Blocal_props_r2_i("buf_B1_Blocal_props_r2_i",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Bfirst_props_r2_r("buf_B1_Bfirst_props_r2_r",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Bfirst_props_r2_i("buf_B1_Bfirst_props_r2_i",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Bsecond_props_r2_r("buf_B1_Bsecond_props_r2_r",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Bsecond_props_r2_i("buf_B1_Bsecond_props_r2_i",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Bthird_props_r2_r("buf_B1_Bthird_props_r2_r",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Bthird_props_r2_i("buf_B1_Bthird_props_r2_i",   {Lt, Vsnk/sites_per_rank, sites_per_rank, 1, 1, 1, 1, 1, 1, Nc, Ns}, p_float64, a_temporary);
...
// computation B1_Blocal_r2_r_props_init("B1_Blocal_r2_r_props_init", {t, x_out, x_in, x2, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((double) 0));
    B1_Blocal_r2_r_props_init.store_in(&buf_B1_Blocal_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Blocal_r2_i_props_init.store_in(&buf_B1_Blocal_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bfirst_r2_r_props_init.store_in(&buf_B1_Bfirst_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bfirst_r2_i_props_init.store_in(&buf_B1_Bfirst_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bsecond_r2_r_props_init.store_in(&buf_B1_Bsecond_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bsecond_r2_i_props_init.store_in(&buf_B1_Bsecond_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bthird_r2_r_props_init.store_in(&buf_B1_Bthird_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bthird_r2_i_props_init.store_in(&buf_B1_Bthird_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Blocal_r2_r_props.store_in(&buf_B1_Blocal_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Blocal_r2_i_props.store_in(&buf_B1_Blocal_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bfirst_r2_r_props.store_in(&buf_B1_Bfirst_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bfirst_r2_i_props.store_in(&buf_B1_Bfirst_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bsecond_r2_r_props.store_in(&buf_B1_Bsecond_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bsecond_r2_i_props.store_in(&buf_B1_Bsecond_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bthird_r2_r_props.store_in(&buf_B1_Bthird_props_r2_r, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
    B1_Bthird_r2_i_props.store_in(&buf_B1_Bthird_props_r2_i, {t, x_out, x_in, 0, 0, 0, 0, 0, 0, jCprime, jSprime});
