...
// BB_H
    ...
    computation copy_buf_C_r_host_to_device({t, x_out, x_in, rp, mpmH, r, npnH}, memcpy(buf_C_r_cpu, buf_C_r));
    computation copy_buf_C_i_host_to_device({t, x_out, x_in, rp, mpmH, r, npnH}, memcpy(buf_C_i_cpu, buf_C_i));
    ...
    computation copy_buf_C_r_device_to_host({t, x_out, x_in, rp, mpmH, r, npnH}, memcpy(buf_C_r, buf_C_r_cpu));
    computation copy_buf_C_i_device_to_host({t, x_out, x_in, rp, mpmH, r, npnH}, memcpy(buf_C_i, buf_C_i_cpu));
