        ...
        for (int i3 = 0; i3 < BZ; i3++)
         {
           ...
           for (int k = 1; k <= BK; k++)
	   {
          std::cout << xp0 << " " << a1 << " " << t << " " << i1 << " " << i2 << " " << i3 << " " << k << std::endl;
          std::cout << "limits :" << std::endl;
          std::cout << "k limits : " <<  BARYON_N << std::endl;
          std::cout << "fc1[k] limit: " << BARYON_P1 << std::endl;
          std::cout << "fc1[k]=" << fc1[k] << std::endl;;
	       float Res0    =  S[xp0][a1][t][i1][i2][i3][fc1[k]];
         Res0 *= S[xp0][a2][t][i1][i2][i3][fc2[k]];
         Res0 *= S[xp0][a3][t][i1][i2][i3][fc3[k]];
