...
void generate_function(std::string name)
{
   ...
   input C_r("C_r",      {t, x_out, m, r, n}, p_float64);
   input C_i("C_i",      {t, x_out, m, r, n}, p_float64);
   ...
   input snk_blocks("snk_blocks", {r}, p_int32);
    ...
    complex_expr B1_r1_prop_0p = B1_prop(0, t, kCprime, kSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr B1_r1_prop_2p = B1_prop(2, t, iCprime, iSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    ...
    computation C_init_r("C_init_r", {t, x_out, m, r, n}, expr((double) 0));
    computation C_init_i("C_init_i", {t, x_out, m, r, n}, expr((double) 0));

    computation C_prop_init_r("C_prop_init_r", {t, x_out, x_in, m, r}, expr((double) 0));
    computation C_prop_init_i("C_prop_init_i", {t, x_out, x_in, m, r}, expr((double) 0));
    
    int b=0;
    /* r1, b = 0 */
    complex_computation new_term_0_r1_b1("new_term_0_r1_b1", {t, x_out, x_in,  m, r, wnum}, B1_Blocal_r1_init(t, x_out, x_in, snk_color_weights(r, wnum, 0), snk_spin_weights(r, wnum, 0), snk_color_weights(r, wnum, 2), snk_spin_weights(r, wnum, 2), snk_color_weights(r, wnum, 1), snk_spin_weights(r, wnum, 1), m));
    new_term_0_r1_b1.add_predicate(snk_blocks(r) == 1);
    /* r2, b = 0 */
    complex_computation new_term_0_r2_b1("new_term_0_r2_b1", {t, x_out, x_in,  m, r, wnum}, B1_Blocal_r2_init(t, x_out, x_in, snk_color_weights(r, wnum, 0), snk_spin_weights(r, wnum, 0), snk_color_weights(r, wnum, 2), snk_spin_weights(r, wnum, 2), snk_color_weights(r, wnum, 1), snk_spin_weights(r, wnum, 1), m));
    new_term_0_r2_b1.add_predicate(snk_blocks(r) == 2);

    complex_expr prefactor(cast(p_float64, snk_weights(r, wnum)), 0.0);

    complex_expr term_res_b1 = new_term_0_r1_b1(t, x_out, x_in, m, r, wnum);
    ...
    computation C_prop_update_r("C_prop_update_r", {t, x_out, x_in, m, r, wnum}, C_prop_init_r(t, x_out, x_in, m, r) + term_res.get_real());
    computation C_prop_update_i("C_prop_update_i", {t, x_out, x_in, m, r, wnum}, C_prop_init_i(t, x_out, x_in, m, r) + term_res.get_imag());

    complex_computation C_prop_update(&C_prop_update_r, &C_prop_update_i);

    complex_expr term = C_prop_update(t, x_out, x_in, m, r, Nw-1) * snk_psi;

    computation C_update_r("C_update_r", {t, x_out, x_in, m, r, n}, C_init_r(t, x_out, m, r, n) + term.get_real());
    computation C_update_i("C_update_i", {t, x_out, x_in, m, r, n}, C_init_i(t, x_out, m, r, n) + term.get_imag());
    ...
    buffer buf_C_r("buf_C_r", {Lt, 1, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_input);
    buffer buf_C_i("buf_C_i", {Lt, 1, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_input);
    ...
    C_init_r.store_in(&buf_C_r, {t, x_out, m, r, n});
    C_init_i.store_in(&buf_C_i, {t, x_out, m, r, n});
    C_update_r.store_in(&buf_C_r, {t, x_out, m, r, n});
    C_update_i.store_in(&buf_C_i, {t, x_out, m, r, n});
...
void generate_function_gpu(std::string name)
{
    tiramisu::init(name);
   ...
   input snk_blocks("snk_blocks", {r}, p_int32);
    ...
    buffer buf_B1_Blocal_diquark_r1_r_cpu("buf_B1_Blocal_diquark_r1_r_cpu",   {1}, p_float64, a_temporary);
    buffer buf_B1_Blocal_diquark_r1_i_cpu("buf_B1_Blocal_diquark_r1_i_cpu",   {1}, p_float64, a_temporary);
    buffer buf_B1_Blocal_props_r1_r_cpu("buf_B1_Blocal_props_r1_r_cpu",   {Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Blocal_props_r1_i_cpu("buf_B1_Blocal_props_r1_i_cpu",   {Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Blocal_r2_r_cpu("buf_B1_Blocal_r2_r_cpu",   {Nc, Ns, Nc, Ns, Nc, Ns, NsrcHex}, p_float64, a_temporary);
    buffer buf_B1_Blocal_r2_i_cpu("buf_B1_Blocal_r2_i_cpu",   {Nc, Ns, Nc, Ns, Nc, Ns, NsrcHex}, p_float64, a_temporary);
    buffer buf_B1_Blocal_diquark_r2_r_cpu("buf_B1_Blocal_diquark_r2_r_cpu",   {1}, p_float64, a_temporary);
    buffer buf_B1_Blocal_diquark_r2_i_cpu("buf_B1_Blocal_diquark_r2_i_cpu",   {1}, p_float64, a_temporary);
    buffer buf_B1_Blocal_props_r2_r_cpu("buf_B1_Blocal_props_r2_r_cpu",   {Nc, Ns}, p_float64, a_temporary);
    buffer buf_B1_Blocal_props_r2_i_cpu("buf_B1_Blocal_props_r2_i_cpu",   {Nc, Ns}, p_float64, a_temporary);
    buffer buf_C_r_cpu("buf_C_r_cpu", {Lt, 1, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_input);
    buffer buf_C_i_cpu("buf_C_i_cpu", {Lt, 1, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_input);
    buffer* buf_new_term_r_b1_cpu;//("buf_new_term_r_b1", {1}, p_float64, a_temporary);
    buffer* buf_new_term_i_b1_cpu;//("buf_new_term_i_b1", {1}, p_float64, a_temporary);
    allocate_complex_buffers(buf_new_term_r_b1_cpu, buf_new_term_i_b1_cpu, {1}, "buf_new_term_b1_cpu");
    buffer buf_C_prop_r_cpu("buf_C_prop_r_cpu", {1}, p_float64, a_temporary);
    buffer buf_C_prop_i_cpu("buf_C_prop_i_cpu", {1}, p_float64, a_temporary);

    computation copy_buf_B1_Blocal_r1_r_cpu_to_device({}, memcpy(buf_B1_Blocal_r1_r_cpu, buf_B1_Blocal_r1_r));
    computation copy_buf_B1_Blocal_r1_i_cpu_to_device({}, memcpy(buf_B1_Blocal_r1_i_cpu, buf_B1_Blocal_r1_i));
    computation copy_buf_B1_Blocal_diquark_r1_r_cpu_to_device({}, memcpy(buf_B1_Blocal_diquark_r1_r_cpu, buf_B1_Blocal_diquark_r1_r));
    computation copy_buf_B1_Blocal_diquark_r1_i_cpu_to_device({}, memcpy(buf_B1_Blocal_diquark_r1_i_cpu, buf_B1_Blocal_diquark_r1_i));
    computation copy_buf_B1_Blocal_props_r1_r_cpu_to_device({}, memcpy(buf_B1_Blocal_props_r1_r_cpu, buf_B1_Blocal_props_r1_r));
    computation copy_buf_B1_Blocal_props_r1_i_cpu_to_device({}, memcpy(buf_B1_Blocal_props_r1_i_cpu, buf_B1_Blocal_props_r1_i));
    computation copy_buf_B1_Blocal_r2_r_cpu_to_device({}, memcpy(buf_B1_Blocal_r2_r_cpu, buf_B1_Blocal_r2_r));
    computation copy_buf_B1_Blocal_r2_i_cpu_to_device({}, memcpy(buf_B1_Blocal_r2_i_cpu, buf_B1_Blocal_r2_i));
    computation copy_buf_B1_Blocal_diquark_r2_r_cpu_to_device({}, memcpy(buf_B1_Blocal_diquark_r2_r_cpu, buf_B1_Blocal_diquark_r2_r));
    computation copy_buf_B1_Blocal_diquark_r2_i_cpu_to_device({}, memcpy(buf_B1_Blocal_diquark_r2_i_cpu, buf_B1_Blocal_diquark_r2_i));
    computation copy_buf_B1_Blocal_props_r2_r_cpu_to_device({}, memcpy(buf_B1_Blocal_props_r2_r_cpu, buf_B1_Blocal_props_r2_r));
    computation copy_buf_B1_Blocal_props_r2_i_cpu_to_device({}, memcpy(buf_B1_Blocal_props_r2_i_cpu, buf_B1_Blocal_props_r2_i));
    computation copy_buf_C_r_cpu_to_device({}, memcpy(buf_C_r_cpu, buf_C_r));
    computation copy_buf_C_i_cpu_to_device({}, memcpy(buf_C_i_cpu, buf_C_i));
    computation copy_buf_new_term_r_b1_cpu_to_device({}, memcpy(*buf_new_term_r_b1_cpu, *buf_new_term_r_b1));
    computation copy_buf_new_term_i_b1_cpu_to_device({}, memcpy(*buf_new_term_i_b1_cpu, *buf_new_term_i_b1));
    computation copy_buf_C_prop_r_cpu_to_device({}, memcpy(buf_C_prop_r_cpu, buf_C_prop_r));
    computation copy_buf_C_prop_i_cpu_to_device({}, memcpy(buf_C_prop_i_cpu, buf_C_prop_i));

    computation copy_buf_B1_Blocal_r1_r_device_to_cpu({}, memcpy(buf_B1_Blocal_r1_r, buf_B1_Blocal_r1_r_cpu));
    computation copy_buf_B1_Blocal_r1_i_device_to_cpu({}, memcpy(buf_B1_Blocal_r1_i, buf_B1_Blocal_r1_i_cpu));
    computation copy_buf_B1_Blocal_diquark_r1_r_device_to_cpu({}, memcpy(buf_B1_Blocal_diquark_r1_r, buf_B1_Blocal_diquark_r1_r_cpu));
    computation copy_buf_B1_Blocal_diquark_r1_i_device_to_cpu({}, memcpy(buf_B1_Blocal_diquark_r1_i, buf_B1_Blocal_diquark_r1_i_cpu));
    computation copy_buf_B1_Blocal_props_r1_r_device_to_cpu({}, memcpy(buf_B1_Blocal_props_r1_r, buf_B1_Blocal_props_r1_r_cpu));
    computation copy_buf_B1_Blocal_props_r1_i_device_to_cpu({}, memcpy(buf_B1_Blocal_props_r1_i, buf_B1_Blocal_props_r1_i_cpu));
    computation copy_buf_B1_Blocal_r2_r_device_to_cpu({}, memcpy(buf_B1_Blocal_r2_r, buf_B1_Blocal_r2_r_cpu));
    computation copy_buf_B1_Blocal_r2_i_device_to_cpu({}, memcpy(buf_B1_Blocal_r2_i, buf_B1_Blocal_r2_i_cpu));
    computation copy_buf_B1_Blocal_diquark_r2_r_device_to_cpu({}, memcpy(buf_B1_Blocal_diquark_r2_r, buf_B1_Blocal_diquark_r2_r_cpu));
    computation copy_buf_B1_Blocal_diquark_r2_i_device_to_cpu({}, memcpy(buf_B1_Blocal_diquark_r2_i, buf_B1_Blocal_diquark_r2_i_cpu));
    computation copy_buf_B1_Blocal_props_r2_r_device_to_cpu({}, memcpy(buf_B1_Blocal_props_r2_r, buf_B1_Blocal_props_r2_r_cpu));
    computation copy_buf_B1_Blocal_props_r2_i_device_to_cpu({}, memcpy(buf_B1_Blocal_props_r2_i, buf_B1_Blocal_props_r2_i_cpu));
    computation copy_buf_C_r_device_to_cpu({}, memcpy(buf_C_r, buf_C_r_cpu));
    computation copy_buf_C_i_device_to_cpu({}, memcpy(buf_C_i, buf_C_i_cpu));
    computation copy_buf_new_term_r_b1_device_to_cpu({}, memcpy(*buf_new_term_r_b1, *buf_new_term_r_b1_cpu));
    computation copy_buf_new_term_i_b1_device_to_cpu({}, memcpy(*buf_new_term_i_b1, *buf_new_term_i_b1_cpu));
    computation copy_buf_C_prop_r_device_to_cpu({}, memcpy(buf_C_prop_r, buf_C_prop_r_cpu));
    computation copy_buf_C_prop_i_device_to_cpu({}, memcpy(buf_C_prop_i, buf_C_prop_i_cpu));
    ...
    computation* handle = &(copy_buf_B1_Blocal_r1_r_cpu_to_device
    .then(copy_buf_B1_Blocal_r1_i_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r1_r_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r1_i_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_props_r1_r_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_props_r1_i_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_r2_r_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_r2_i_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r2_r_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r2_i_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_props_r2_r_cpu_to_device, computation::root)
    .then(copy_buf_B1_Blocal_props_r2_i_cpu_to_device, computation::root)
    .then(copy_buf_C_r_cpu_to_device, computation::root)
    .then(copy_buf_C_i_cpu_to_device, computation::root)
    .then(copy_buf_new_term_r_b1_cpu_to_device, computation::root)
    .then(copy_buf_new_term_i_b1_cpu_to_device, computation::root)
    .then(copy_buf_C_prop_r_cpu_to_device, computation::root)
    .then(copy_buf_C_prop_i_cpu_to_device, computation::root));
    ...
    handle = &(handle->
     then(copy_buf_B1_Blocal_r1_r_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_r1_i_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r1_r_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r1_i_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_props_r1_r_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_props_r1_i_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_r2_r_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_r2_i_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r2_r_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_diquark_r2_i_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_props_r2_r_device_to_cpu, computation::root)
    .then(copy_buf_B1_Blocal_props_r2_i_device_to_cpu, computation::root)
    .then(copy_buf_C_r_device_to_cpu, computation::root)
    .then(copy_buf_C_i_device_to_cpu, computation::root)
    .then(copy_buf_new_term_r_b1_device_to_cpu, computation::root)
    .then(copy_buf_new_term_i_b1_device_to_cpu, computation::root)
    .then(copy_buf_C_prop_r_device_to_cpu, computation::root)
    .then(copy_buf_C_prop_i_device_to_cpu, computation::root));
    ...
    tiramisu::codegen({
        ...
        snk_psi_r.get_buffer(), snk_psi_i.get_buffer(),
             ...
             &buf_B1_Blocal_diquark_r1_r_cpu,
             &buf_B1_Blocal_diquark_r1_i_cpu,
             &buf_B1_Blocal_props_r1_r_cpu,
             &buf_B1_Blocal_props_r1_i_cpu,
             &buf_B1_Blocal_r2_r_cpu,
             &buf_B1_Blocal_r2_i_cpu,
             &buf_B1_Blocal_diquark_r2_r_cpu,
             &buf_B1_Blocal_diquark_r2_i_cpu,
             &buf_B1_Blocal_props_r2_r_cpu,
             &buf_B1_Blocal_props_r2_i_cpu,
             &buf_C_r_cpu,
             &buf_C_i_cpu,
             buf_new_term_r_b1_cpu,
             buf_new_term_i_b1_cpu,
             &buf_C_prop_r_cpu,
             &buf_C_prop_i_cpu
        }, 
...
int main(int argc, char **argv)
{
    ...
    generate_function_gpu("tiramisu_make_fused_baryon_blocks_correlator");
