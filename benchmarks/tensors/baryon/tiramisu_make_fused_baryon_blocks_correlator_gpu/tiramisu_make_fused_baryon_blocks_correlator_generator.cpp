...
// {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, wnumBlock}
    B1_Blocal_r1_r_diquark.tag_parallel_level(t);//, iCprime, iSprime, kCprime, kSprime);
    B1_Blocal_r1_i_diquark.tag_parallel_level(t);//, iCprime, iSprime, kCprime, kSprime);
// {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}
    B1_Blocal_r1_r_props.tag_parallel_level(t);//, iCprime, iSprime, kCprime, kSprime);
    B1_Blocal_r1_i_props.tag_parallel_level(t);//, iCprime, iSprime, kCprime, kSprime);
