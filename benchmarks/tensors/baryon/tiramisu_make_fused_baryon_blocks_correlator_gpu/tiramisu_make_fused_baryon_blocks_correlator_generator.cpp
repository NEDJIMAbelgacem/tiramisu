...
// {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}
    B1_Blocal_r1_r_props_init.tag_gpu_level(x_out, x_in, iCprime, iSprime);
    B1_Blocal_r1_i_props_init.tag_gpu_level(x_out, x_in, iCprime, iSprime);
// {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, wnumBlock}
    B1_Blocal_r1_r_diquark.tag_gpu_level(x_out, x_in, iCprime, iSprime);
    B1_Blocal_r1_i_diquark.tag_gpu_level(x_out, x_in, iCprime, iSprime);
// {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}
    B1_Blocal_r1_r_props.tag_gpu_level(x_out, x_in, iCprime, iSprime);
    B1_Blocal_r1_i_props.tag_gpu_level(x_out, x_in, iCprime, iSprime);
// {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime, m}
    B1_Blocal_r1_r_update.tag_gpu_level(x_out, x_in, iCprime, iSprime);
    B1_Blocal_r1_i_update.tag_gpu_level(x_out, x_in, iCprime, iSprime);
