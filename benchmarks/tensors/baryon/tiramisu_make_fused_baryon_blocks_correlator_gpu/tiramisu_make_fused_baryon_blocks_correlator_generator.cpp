...
// declaring buffers
   ...
   buf_sigs.tag_gpu_global();
    ...
    B1_Blocal_r1_r_props_init.store_in(&buf_B1_Blocal_props_r1_r, {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime});
    B1_Blocal_r1_i_props_init.store_in(&buf_B1_Blocal_props_r1_i, {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime});
    B1_Blocal_r1_r_props.store_in(&buf_B1_Blocal_props_r1_r, {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime});
    B1_Blocal_r1_i_props.store_in(&buf_B1_Blocal_props_r1_i, {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime});
