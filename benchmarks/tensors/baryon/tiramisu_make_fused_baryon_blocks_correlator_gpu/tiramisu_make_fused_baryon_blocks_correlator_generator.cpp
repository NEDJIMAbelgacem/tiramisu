...
void generate_function(std::string name)
{
   ...
   input sigs("sigs", {nperm}, p_int32);
    ...
    complex_expr B1_r1_prop_1 =  B1_prop(1, t, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x_in*sites_per_rank+x_out, y);
    ...
    complex_expr B1_r2_prop_1 = B1_prop(1, t, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x_in*sites_per_rank+x_out, y);
