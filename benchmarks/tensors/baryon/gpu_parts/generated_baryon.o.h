#ifndef HALIDE__generated_baryon_o_h
#define HALIDE__generated_baryon_o_h
#include <stdint.h>
...
int tiramisu_generated_code(struct halide_buffer_t *_buf_res2_cpu_buffer, struct halide_buffer_t *_buf_S_cpu_buffer, struct halide_buffer_t *_buf_wp_cpu_buffer, struct halide_buffer_t *_buf_fc1_cpu_buffer, struct halide_buffer_t *_buf_fc2_cpu_buffer, struct halide_buffer_t *_buf_fc3_cpu_buffer) HALIDE_FUNCTION_ATTRS;
int tiramisu_generated_code_old_buffer_t(struct buffer_t *_buf_res2_cpu, struct buffer_t *_buf_S_cpu, struct buffer_t *_buf_wp_cpu, struct buffer_t *_buf_fc1_cpu, struct buffer_t *_buf_fc2_cpu, struct buffer_t *_buf_fc3_cpu) HALIDE_FUNCTION_ATTRS;
